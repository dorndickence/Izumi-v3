...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~qMd0UWDw",
  MENU_URL: process.env.MENU_URL || "https://i.imgur.com/cO0TZJv.jpeg",
  CAPTION: process.env.CAPTION || "Iᴢᴜᴍɪ",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "Dorn Dickence",
  BOT_NAME: process.env.BOT_NAME || "𝐖𝐚𝐥𝐤𝐢𝐧𝐠 𝐜𝐡𝐞𝐦𝐢𝐜𝐚𝐥-𝚅3",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "𝐰𝐚𝐥𝐤𝐢𝐧𝐠-v3,❤️",
  ...
  AUTHOR: process.env.AUTHOR || "𝐃𝐨𝐫𝐧𝐚𝐯𝐚𝐧",
